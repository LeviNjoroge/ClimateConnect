...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="chatbot.html" class="nav-item nav-link"><i class="fa fa-robot me-2 text-danger"></i>AI Chatbot</a>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2 text-warning"></i>Pages</a>
                <div class="dropdown-menu bg-transparent border-0">
...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        <div class="col-sm-6 col-xl-3">
            <div class="rounded d-flex align-items-center justify-content-between p-4" style="background-color: #484776; color: white;">
                <i class="fa fa-leaf fa-3x text-success"></i>
                <div class="ms-3">
                    <p class="mb-2">Carbon Reduction Today</p>
                    <h6 class="mb-0">120 kg CO₂ saved</h6>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-xl-3">
            <div class="rounded d-flex align-items-center justify-content-between p-4" style="background-color: #33C2ED; color: white;">
                <i class="fa fa-globe fa-3x text-danger"></i>
                <div class="ms-3">
                    <p class="mb-2">Total CO₂ Offset</p>
                    <h6 class="mb-0">14.2M tons</h6>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-xl-3">
            <div class="rounded d-flex align-items-center justify-content-between p-4" style="background-color: #10A465; color: white;">
                <i class="fa fa-solar-panel fa-3x text-warning"></i>
                <div class="ms-3">
                    <p class="mb-2">Renewable Energy Usage</p>
                    <h6 class="mb-0">46%</h6>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-xl-3">
            <div class="rounded d-flex align-items-center justify-content-between p-4" style="background: linear-gradient(to right, #E1E4E8, black); color: white;">
                <i class="fa fa-hand-holding-usd fa-3x text-primary"></i>
                <div class="ms-3">
                    <p class="mb-2">Climate Investments</p>
                    <h6 class="mb-0">$14M</h6>
                </div>
            </div>
        </div>
    </div>
